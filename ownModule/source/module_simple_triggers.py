...
# This trigger is deprecated. Use "script_game_event_simulate_battle" in module_scripts.py instead 
  ...
  (0,
   [
      (try_begin),
        (neq, "$g_mod_version", 1389),  
        (assign, "$g_mod_version", 1389),
      (try_end),
      (try_begin),
   ...
   [
     (try_for_range, ":center_no", centers_begin, centers_end),
       ...
       (else_try),
         ...
         (store_div, ":value_change", ":dif", 5),
         (store_mul, ":value_change_correction", ":value_change", 5),
   ...
   [
    (try_for_range, ":center_no", centers_begin, centers_end),
      ...
      (try_for_range, ":improvement_no", ":begin", ":end"),
        (party_get_slot, ":cur_improvement_end_time", ":center_no", ":improvement_no"),
        (gt, ":cur_improvement_end_time", 1),
        (store_current_hours, ":cur_hours"),
        (ge, ":cur_hours", ":cur_improvement_end_time"),
        (party_set_slot, ":center_no", ":improvement_no", 1),
        (call_script, "script_get_improvement_details", ":improvement_no", ":center_no"),
        (try_begin),
          (party_slot_eq, ":center_no", slot_town_lord, "trp_player"),
          (str_store_party_name, s4, ":center_no"),
          (display_log_message, "@Building of {s0} in {s4} has been completed."),
   ...
   [
      ...
      (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
        ...
        (try_for_range_backwards, ":stack_no", 1, ":num_stacks"),
          ...
          (neq, ":stack_troop", "trp_caravan_guard"),
          (neq, ":stack_troop", "trp_mercenary_horseman"),
          (neq, ":stack_troop", "trp_mercenary_cavalry"),
      ...
      (try_for_range, ":rebel_faction", rebel_kingdoms_begin, ":end_cond"),
        ...
        (try_for_range, ":cur_troop", lords_begin, lords_end),
          ...
          (else_try),
            ...
            (assign, ":relation", reg0),
            (call_script, "script_troop_get_relation_with_troop", ":cur_troop", ":rebel_king"),
            (assign, ":relation_2", reg0),
            (val_sub, ":relation", ":relation_2"),
            # other faction
            (try_begin),
            ...
            (try_end),
            # random
            (store_random_in_range, ":rand_no", -10, 11),
            (val_sub, ":relation", ":rand_no"),
            # inactive_days
            (store_div, ":days_effect", ":inactive_days", 10),
            (val_sub, ":relation", ":days_effect"),
            (le, ":relation", -30),
            (val_add, ":fitful_lords", 1),
            (troop_set_slot, ":cur_troop", slot_troop_temp_slot, ":rebel_faction"),
            (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
        ...
        ## start rebellion 
        (try_begin),
          (store_div, ":least_centers", ":total_walled_centers", 3),
    ...
    (try_for_parties, ":party_no"),
      ...
      (else_try),
        ...
        (else_try),
          ...
          (party_get_position, pos5, ":spawnpoint"),
  ...
  (3, 
    [
      (try_for_range, ":troop_no", heroes_begin, heroes_end),
        ...
        (ge, ":party_no", 1),
        (party_is_active, ":party_no"),
        (party_get_attached_to, ":cur_center", ":party_no"),
        (is_between, ":cur_center", walled_centers_begin, walled_centers_end),
        (party_slot_eq, ":cur_center", slot_town_lord, ":troop_no"),
        (store_faction_of_party, ":center_faction", ":cur_center"),
        (faction_get_color, ":faction_color", ":center_faction"),
        # (faction_get_slot, ":culture", ":center_faction", slot_faction_culture),
        # (faction_get_slot, ":center_faction", ":culture", slot_faction_culture),
        # (troop_get_slot, ":lord_faction", ":troop_no", slot_troop_original_faction),
        # (party_get_slot, ":center_original_faction", ":cur_center", slot_center_original_faction),
        ...
        (try_begin),
          (call_script, "script_get_member_rate_of_party", ":party_no"),
          (assign, ":member_rate_of_party", reg0),
          (call_script, "script_get_member_rate_of_party", ":cur_center"),
          (assign, ":member_rate_of_center", reg0),
          (store_sub, ":rate_offset", ":member_rate_of_center", ":member_rate_of_party"),
          (neg|is_between, ":rate_offset", -5, 25), # lose balance
          (try_begin), # move town/castle troops to lord's party
            (ge, ":rate_offset", 25),
            (assign, ":target_party", ":party_no"),
            (assign, ":source_party", ":cur_center"),
          (else_try), # move lord's troops to town/castle
            (lt, ":rate_offset", -5),
            (assign, ":target_party", ":cur_center"),
            (assign, ":source_party", ":party_no"),
          (try_end),
          
          (party_get_num_companions, ":party_size_begin", ":target_party"),
          (try_for_range, ":unused", 0, 3),
            ...
            (try_for_range_backwards, ":cur_stack", 0, ":num_stacks"),
              (try_begin),
                ...
                (store_sub, ":rate_offset", ":member_rate_of_center", ":member_rate_of_party"),
                (try_begin),
                  (is_between, ":rate_offset", -5, 25), # already balance
                  (assign, ":num_stacks", 0), # stop
                (try_end),
                (try_begin),
                  (eq, ":source_party", ":cur_center"), # move town/castle troops to lord's party
                  (le, ":member_rate_of_center", 40), # ":member_rate_of_center" lt 40%
                  (assign, ":num_stacks", 0), # stop
                (try_end),
              (try_end),
              (gt, ":num_stacks", 0),
              (party_stack_get_troop_id, ":cur_troop", ":source_party", ":cur_stack"),
              (neg|troop_is_hero, ":cur_troop"),
              # (store_troop_faction, ":troop_faction", ":cur_troop"),
              # (this_or_next|eq, ":troop_faction", ":lord_faction"),
              # (this_or_next|eq, ":troop_faction", ":center_faction"),
              # (eq, ":troop_faction", ":center_original_faction"),
              (party_stack_get_size, ":stack_size", ":source_party", ":cur_stack"),
              (try_begin),
                (eq, ":unused", 0), # the 1st round, move small group troops below 6, not by ratio
                (try_begin),
                  (le, ":stack_size", 5),
                (else_try),
                  (assign, ":stack_size", 0),
              ...
              (else_try),
                (try_begin),
                  (le, ":stack_size", 5),
                (else_try),
                  (store_random_in_range, ":rand_no", 15, 30),
                  (val_mul, ":stack_size", ":rand_no"),
                  (val_div, ":stack_size", 100),
                (try_end),
              (try_end),
              (gt, ":stack_size", 0),
              (party_remove_members, ":source_party", ":cur_troop", ":stack_size"),
              (party_add_members, ":target_party", ":cur_troop", ":stack_size"),
            (try_end),
          (try_end),
          (party_get_num_companions, ":party_size_end", ":target_party"),
          (store_sub, ":num_moved", ":party_size_end", ":party_size_begin"),
          (ge, ":num_moved", 50), # lt 50 display no message 
          (assign, reg0, ":num_moved"),
          (str_store_troop_name, s3, ":troop_no"),
          (str_store_party_name, s4, ":cur_center"),
          (try_begin),
            (eq, ":target_party", ":party_no"),
            (display_message, "@{s3} has taken {reg0} troops from {s4}.", ":faction_color"),
          (else_try),
            (eq, ":target_party", ":cur_center"),
        ...
        # (try_begin),
          # (party_get_num_companions, ":party_size_begin", ":cur_center"),
          # (troop_get_slot, ":lord_faction", ":troop_no", slot_troop_original_faction),
          # (party_get_slot, ":center_original_faction", ":cur_center", slot_center_original_faction),
          # (try_for_range, ":unused", 0, 3),
            # (party_get_num_companion_stacks, ":num_stacks", ":party_no"),
            # (try_for_range_backwards, ":cur_stack", 0, ":num_stacks"),
              # (try_begin),
                # (party_get_num_companions, ":party_size", ":party_no"),
                # (party_get_num_companions, ":center_size", ":cur_center"),
                ...
                # (call_script, "script_get_member_rate_of_party", ":cur_center"),
                # (assign, ":member_rate_of_center", reg0),
                # (store_sub, ":rate_offset", ":member_rate_of_party", ":member_rate_of_center"),
              ...
              # (gt, ":stack_size", 0),
              # (party_remove_members, ":party_no", ":cur_troop", ":stack_size"),
              # (party_add_members, ":cur_center", ":cur_troop", ":stack_size"),
            # (try_end),
          # (try_end),
          # (party_get_num_companions, ":party_size_end", ":cur_center"),
          # (store_sub, ":num_moved", ":party_size_end", ":party_size_begin"),
          # (ge, ":num_moved", 40), # lt 40 display no message 
          # (assign, reg0, ":num_moved"),
          # (str_store_troop_name, s3, ":troop_no"),
          # (str_store_party_name, s4, ":cur_center"),
          # (display_message, "@{s3} has given {reg0} troops to {s4}.", ":faction_color"),
 ...
 (1,
  ...
  (1,
    [
      ...
      (party_slot_eq, "$auto_enter_town", slot_center_has_training_field, 1),
      (party_get_num_companion_stacks, ":num_stacks", "p_main_party"),
    ...
    [
      ...
      (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
        ...
        (try_begin),
          ...
          (val_div, ":hours_needed", 4),
        (try_end),
        (party_get_slot, ":last_time", ":center_no", slot_town_last_recruit_time),
