...
slot_center_has_messenger_post   = 133 #town, castle, village

# slot hack
slot_center_has_smelter          = slot_center_has_fish_pond    #town
slot_center_has_training_field   = slot_center_has_fish_pond    #castle
slot_center_has_prisoner_tower   = slot_center_has_watch_tower  #town, castle
slot_center_has_barrack          = slot_center_has_school       #town, castle

village_improvements_begin       = slot_center_has_manor
village_improvements_end         = 134

walled_center_improvements_begin = slot_center_has_fish_pond
walled_center_improvements_end   = 134
## CC
...
spt_deserter_footman          = 21
spt_deserter_archer           = 22
spt_deserter_horse_man        = 23
spt_deserter_horse_archer     = 24
...
## CC
reinforcement_cost_easy = 800
reinforcement_cost_moderate = 600
reinforcement_cost_hard = 400
## CC
...
num_kingdoms = fac_kingdoms_end - fac_kingdom_1

rebel_kingdoms_begin = "fac_kingdom_1_noble_rebels"
rebel_kingdoms_end = commom_kingdoms_begin

npc_kingdoms_begin = rebel_kingdoms_begin
...
## CC
kingdom_troops_begin = "trp_swadian_recruit"
...
mercenary_troops_end = "trp_manhunter"

female_soldiers_begin = "trp_follower_woman"
...
banner_meshes_end_minus_one = "mesh_banner_default"

arms_meshes_begin = "mesh_arms_a01"
arms_meshes_end_minus_one = "mesh_arms_default"

banner_map_icons_begin = "icon_banner_01"
banner_map_icons_end_minus_one = "icon_banner_default" 

banner_scene_props_begin = "spr_banner_a"
banner_scene_props_end_minus_one = "spr_banner_default"
## CC
...
deserter_party_template_begin = "pt_deserters_swadian"
deserter_party_template_end   = "pt_merchant_caravan"

bandit_troops_begin = "trp_forest_bandit"
bandit_troops_end   = "trp_forest_bandit_hero"

bandit_heroes_begin = "trp_forest_bandit_hero"
bandit_heroes_end   = "trp_black_khergit_horseman"

pool_troops_begin = "trp_temp_array_a"
pool_troops_end_minus_one = "trp_temp_array_j"
pool_troops_end = "trp_stack_selection_amounts"


# item slots
slot_item_food_portion            = 64
...
slot_agent_ironflesh_level        = 40

# faction slots
slot_faction_hero_reinforcements_a        = 201
slot_faction_hero_reinforcements_b        = 202
slot_faction_hero_reinforcements_c        = 203

slot_faction_inactive_days                = 204
slot_faction_restoration_times            = 205
slot_faction_rebellion_times              = 206
...
slot_troop_last_recruit_time  = 400
slot_troop_kill_count         = 401
slot_troop_wound_count        = 402
#slot_troop_backup_hp         = 403

slot_troop_wp_mul_1000_one_handed   = 405
slot_troop_wp_mul_1000_two_handed   = 406
slot_troop_wp_mul_1000_polearm      = 407
slot_troop_wp_mul_1000_archery      = 408
slot_troop_wp_mul_1000_crossbow     = 409
slot_troop_wp_mul_1000_throwing     = 410
slot_troop_wp_mul_1000_firearm      = 411

slot_upgrade_weapon = 412
slot_upgrade_armor  = 413
slot_upgrade_horse  = 414

# item_id with item_modifier
# (store_mod, item_modifier, value_in_slot, 100),
# (store_div, item_id, value_in_slot, 100),
...
slot_troop_current_reading_book                  = 420
slot_troop_tactics_reading_progress              = 421
slot_troop_persuasion_reading_progress           = 422
slot_troop_leadership_reading_progress           = 423
slot_troop_intelligence_reading_progress         = 424
slot_troop_prisoner_management_reading_progress  = 425
slot_troop_trade_reading_progress                = 426
slot_troop_weapon_mastery_reading_progress       = 427
slot_troop_engineering_reading_progress          = 428

book_reading_slots_begin = slot_troop_tactics_reading_progress
book_reading_slots_end = slot_troop_engineering_reading_progress+1 

#slot_troop_commensalism_troop   = 431

#slot_derivative_troop_cavalry_style     = 435
#slot_derivative_troop_infantry_style    = 436
#slot_derivative_troop_center_style      = 437
#slot_derivative_troop_player_style      = 438

#slot_all_proficiency_limit        = 436
#slot_one_handed_proficiency_limit = 437
#slot_two_handed_proficiency_limit = 438
#slot_polearm_proficiency_limit    = 439
#slot_archery_proficiency_limit    = 440
#slot_crossbow_proficiency_limit   = 441
#slot_throwing_proficiency_limit   = 442


# party template slots
slot_party_template_has_hero            = 7
