...
#multiplayer game type names
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is a vassal of {s55} of {s56}.^}}Renown: {reg5}. Controversy: {reg15}. Wealth: {reg17}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}"), ## CC
  ...
  #("s1extra_morale_for_s9_troops__reg6_", "{s1}Extra morale for {s9} troops : {reg6}^"), ## CC
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_king_title_1", "King {s0}"),
  ("faction_king_title_2", "King {s0}"),
  ("faction_king_title_3", "{s0} Khan"),
  ("faction_king_title_4", "King {s0}"),
  ("faction_king_title_5", "King {s0}"),
  ("faction_king_title_6", "Sultan {s0}"),
  ...
  ("faction_king_female_title_2", "Queen {s0}"),
  ("faction_king_female_title_3", "{s0} Khan"),
  ("faction_king_female_title_4", "Queen {s0}"),
  ("faction_king_female_title_5", "Queen {s0}"),
  ("faction_king_female_title_6", "Sultan {s0}"),
  ## CC
...
## CC
  ...
  ("bandit_name_10", "Hollis"),
  ("bandit_name_11", "Forster"),
  ("bandit_name_12", "Trevor"),
  ("bandit_name_13", "York"),
  ("bandit_name_14", "Oren"),
  ("bandit_name_15", "Heckett"),
  ("bandit_name_16", "Nigel"),
  ("bandit_name_17", "Oakes"),
  ("bandit_name_18", "Keith"),
  ("bandit_name_19", "Barclay"),
  
  # names: taiga_bandit_leader
  ("bandit_name_20", "Harry"),
  ("bandit_name_21", "Nika"),
  ("bandit_name_22", "Dick"),
  ("bandit_name_23", "Kern"),
  ("bandit_name_24", "Lyndon"),
  ("bandit_name_25", "Theron"),
  ("bandit_name_26", "Kennard"),
  ("bandit_name_27", "Anders"),
  ("bandit_name_28", "Hector"),
  ("bandit_name_29", "Glenn"),
  
  # names: steppe_bandit_leader
  ("bandit_name_30", "Reuben"),
  ("bandit_name_31", "Gordon"),
  ("bandit_name_32", "Harman"),
  ("bandit_name_33", "Slade"),
  ("bandit_name_34", "Ulysses"),
  ("bandit_name_35", "Stanley"),
  ("bandit_name_36", "Graham"),
  ("bandit_name_37", "Winslow"),
  ("bandit_name_38", "Wolfgang"),
  ("bandit_name_39", "Hadley"),
  
  # names: sea_raider_leader
  ("bandit_name_40", "Milo"),
  ("bandit_name_41", "Salman"),
  ("bandit_name_42", "Dustin"),
  ("bandit_name_43", "Marco"),
  ("bandit_name_44", "Gilbert"),
  ("bandit_name_45", "Kelvin"),
  ("bandit_name_46", "Beck"),
  ("bandit_name_47", "Norton"),
  ("bandit_name_48", "Merlin"),
  ("bandit_name_49", "Lewis"),

  # names: mountain_bandit_leader
  ("bandit_name_50", "Kontar"),
  ("bandit_name_51", "Elliot"),
  ("bandit_name_52", "Danny"),
  ("bandit_name_53", "Gamal"),
  ("bandit_name_54", "Alcander"),
  ("bandit_name_55", "Montgomery"),
  ("bandit_name_56", "Erik"),
  ("bandit_name_57", "Tilden"),
  ("bandit_name_58", "Floyd"),
  ("bandit_name_59", "Maurice"),

  # names: desert_bandit_leader
  ("bandit_name_60", "Brooks"),
  ("bandit_name_61", "Wilbur"),
  ("bandit_name_62", "Ghani"),
  ("bandit_name_63", "Kimball"),
  ("bandit_name_64", "Adley"),
  ("bandit_name_65", "Kester"),
  ("bandit_name_66", "Clavin"),
  ("bandit_name_67", "Garrick"),
  ("bandit_name_68", "Omar"),
  ("bandit_name_69", "Ulric"),
  
  ("s21_the_s5_will_never_stop_the_war", "{s21} The {s5} will never stop the war."),
  ...
  ("skl_reserved_1", "Reserved Skill"),
  ("skl_reserved_2", "Reserved Skill"),
  ("skl_reserved_3", "Reserved Skill"),
  ("skl_reserved_4", "Reserved Skill"),
  ...
  ("skl_trainer", "Trainer"),
  ("skl_reserved_5", "Reserved Skill"),
  ("skl_reserved_6", "Reserved Skill"),
  ("skl_reserved_7", "Reserved Skill"),
  ("skl_reserved_8", "Reserved Skill"),
  ("skl_looting", "Looting"),
  ...
  ("skl_reserved_9", "Reserved Skill"),
  ("skl_reserved_10", "Reserved Skill"),
  ("skl_reserved_11", "Reserved Skill"),
  ("skl_reserved_12", "Reserved Skill"),
  ("skl_reserved_13", "Reserved Skill"),
  ("skl_power_draw", "Power Draw"),
  ("skl_power_throw", "Power Throw"),
  ("skl_power_strike", "Power Strike"),
  ("skl_ironflesh", "Ironflesh"),
  ("skl_reserved_14", "Reserved Skill"),
  ("skl_reserved_15", "Reserved Skill"),
  ("skl_reserved_16", "Reserved Skill"),
  ("skl_reserved_17", "Reserved Skill"),
  ("skl_reserved_18", "Reserved Skill"),
  
  # daily hints
  ("daily_hint", "--- Daily Hint ---"),
  ("hint_1", "You can select a NPC in your party as the commander for battles and control he/she to fight in battles personally."),
  ("hint_2", "You can adjust raining and snowing possibilities in MOD options. Snowing for snowlands and raining for the other lands."),
  ("hint_3", "During auto-sell, items in the inventory of companions which selected as the type for sell and their prices below the auto-sell price limit will be sold to all merchants in towns or the elders in villages automaticly. Specifically foods, trade goods and books will never be sold."),
  ("hint_4", "To quickly move members or upgrade members in party window, hold down control key while you left click."),
  ("hint_5", "All parties can reinforce their ally like Lord parties and they can join in the battle directly."),
  ("hint_6", "The total weight of equipments will affect the archery, riding and horse archery skills."),
  ("hint_7", "You can order your soldiers to move to a spot by pressing and holding down F1 key."),
  ("hint_8", "Horses and men move less quickly in rainy weather."),
  ("hint_9", "You can wait on the world map by holding down the space bar."),
  ("hint_10", "You can recruit new men to your party in taverns."),
  ("hint_11", "You can give orders to your party while in battle."),
  ("hint_12", "A party with high morale moves more quickly while travelling on the map."),
  ("hint_13", "Wounded party members will heal faster while resting in taverns."),
  ("hint_14", "To quickly buy and sell items in inventory window, hold down control key while you left click."),
  ("hint_15", "You can press Backspace key during battle to bring the command interface."),
  ("hint_16", "You will pay half wages to your troops while you are staying in a town or castle. Similarly, you will pay half wages to troops you garrison in a castle."),
  ("hint_17", "You can leave any location instantly by pressing the tab key."),
  ("hint_18", "You can hold down the shift key to zoom-in while aiming at distant enemies."),
