...
# item_name, mesh_name, item_properties, item_capabilities, slot_no, cost, bonus_flags, weapon_flags, scale, view_dir, pos_offset
 ...
 ## CC
 ["tutorial_arrows","Arrows", [("arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("quiver", ixmesh_inventory)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(3)|abundance(160)|weapon_length(95)|thrust_damage(0,pierce)|max_ammo(20),imodbits_missile,missile_distance_trigger],
 ...
 ["tutorial_dagger","Dagger", [("practice_dagger",0)], itp_type_one_handed_wpn|itp_primary|itp_secondary, itc_longsword, 3,weight(1.5)|spd_rtng(103)|weapon_length(40)|swing_damage(16,blunt)|thrust_damage(10,blunt),imodbits_none,missile_distance_trigger],
...
# Items before this point are hardwired and their order should not be changed!
 ...
 ["practice_dagger","Practice Dagger", [("practice_dagger",0)], itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry|itp_wooden_attack, itc_dagger|itcf_carry_dagger_front_left, 2,weight(0.5)|spd_rtng(110)|weapon_length(47)|swing_damage(16,blunt)|thrust_damage(14,blunt),imodbits_none,missile_distance_trigger],
...
# ["cheap_shirt","Cheap Shirt", [("shirt",0)], itp_type_body_armor|itp_covers_legs, 0, 4,weight(1.25)|body_armor(3),imodbits_none],
 ...
 ## CC
 ["practice_arrows","Practice Arrows", [("arena_arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("quiver", ixmesh_inventory)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(1.5)|weapon_length(95)|max_ammo(80),imodbits_missile,missile_distance_trigger],
## ["practice_arrows","Practice Arrows", [("arrow",0),("flying_arrow",ixmesh_flying_ammo)], itp_type_arrows, 0, 31,weight(1.5)|weapon_length(95)|max_ammo(80),imodbits_none],
 ["practice_bolts","Practice Bolts", [("bolt",0),("flying_bolt",ixmesh_flying_ammo),("bolt_bag", ixmesh_carry),("bolt_bag_b", ixmesh_carry|imodbit_large_bag),("bolt_bag", ixmesh_inventory),("bolt_bag_b", ixmesh_inventory|imodbit_large_bag)], itp_type_bolts, itcf_carry_quiver_right_vertical, 0,weight(2.25)|weapon_length(55)|max_ammo(49),imodbits_missile,missile_distance_trigger],
 ["practice_arrows_10_amount","Practice Arrows", [("arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("quiver", ixmesh_inventory)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(1.5)|weapon_length(95)|max_ammo(10),imodbits_missile,missile_distance_trigger],
 ["practice_arrows_100_amount","Practice Arrows", [("arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("quiver", ixmesh_inventory)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(1.5)|weapon_length(95)|max_ammo(100),imodbits_missile,missile_distance_trigger],
 ["practice_bolts_9_amount","Practice Bolts", [("bolt",0),("flying_bolt",ixmesh_flying_ammo),("bolt_bag", ixmesh_carry),("bolt_bag_b", ixmesh_carry|imodbit_large_bag),("bolt_bag", ixmesh_inventory),("bolt_bag_b", ixmesh_inventory|imodbit_large_bag)], itp_type_bolts, itcf_carry_quiver_right_vertical, 0,weight(2.25)|weapon_length(55)|max_ammo(9),imodbits_missile,missile_distance_trigger],
 ## CC
...
#This book must be at the beginning of readable books
 ...
 ["book_persuasion","Rhetorica ad Herennium", [("book_b",0)], itp_type_book, 0, 2500,weight(2)|abundance(100),imodbits_none],
...
## CC
 ["book_trade","A Treatise on the Value of Things", [("book_f",0)], itp_type_book, 0, 1550,weight(2)|abundance(100),imodbits_none],
 ["book_weapon_mastery", "On the Art of Fighting with Swords", [("book_d",0)], itp_type_book, 0, 2100,weight(2)|abundance(100),imodbits_none],
...
## CC
 ["book_first_aid_reference","The General Knowledge of First Aid", [("book_f",0)], itp_type_book, 0, 1750,weight(2)|abundance(100),imodbits_none],
## CC
 ["book_training_reference","Manual of Arms", [("book_open",0)], itp_type_book, 0, 1750,weight(2)|abundance(100),imodbits_none],
## CC
 ["book_spotting_reference","The General Knowledge of Spotting", [("book_a",0)], itp_type_book, 0, 1750,weight(2)|abundance(100),imodbits_none],
 ["book_pathfinding_reference","The Atlas of Calradia", [("book_b",0)], itp_type_book, 0, 1750,weight(2)|abundance(100),imodbits_none],
## CC
...
## CC
 ["smoked_fish","Smoked Fish", [("smoked_fish",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 65,weight(15)|abundance(110)|food_quality(50)|max_ammo(100),imodbits_none],
 ["cheese","Cheese", [("cheese_b",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 75,weight(6)|abundance(110)|food_quality(40)|max_ammo(60),imodbits_none],
 ["honey","Honey", [("honey_pot",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 220,weight(5)|abundance(110)|food_quality(40)|max_ammo(60),imodbits_none],
 ["sausages","Sausages", [("sausages",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 85,weight(10)|abundance(110)|food_quality(40)|max_ammo(80),imodbits_none],
 ["cabbages","Cabbages", [("cabbage",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 30,weight(15)|abundance(110)|food_quality(40)|max_ammo(100),imodbits_none],
 ...
 ["raw_grapes","Grapes", [("grapes_inventory",0)], itp_merchandise|itp_consumable|itp_type_goods, 0, 75,weight(4)|abundance(90)|food_quality(10)|max_ammo(20),imodbits_none], #x2 for wine
 ["raw_olives","Olives", [("olive_inventory",0)], itp_merchandise|itp_consumable|itp_type_goods, 0, 100,weight(4)|abundance(90)|food_quality(10)|max_ammo(20),imodbits_none], #x3 for oil
 ["grain","Grain", [("wheat_sack",0)], itp_merchandise|itp_type_goods|itp_consumable, 0, 30,weight(30)|abundance(110)|food_quality(40)|max_ammo(100),imodbits_none],
 ["raw_date_fruit","Date Fruit", [("date_inventory",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 120,weight(4)|food_quality(10)|max_ammo(20),imodbits_none], ## CC
 ...
 ["bread","Bread", [("bread_a",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 50,weight(30)|abundance(110)|food_quality(40)|max_ammo(100),imodbits_none],
 ...
 ["butter","Butter", [("butter_pot",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 150,weight(6)|abundance(110)|food_quality(40)|max_ammo(60),imodbits_none],
## CC
...
# Carthorse, hunter, heavy hunter, hackney, palfrey, courser, destrier.
 ...
 ## CC
 ["warhorse","War Horse", [("warhorse_chain",0)], itp_merchandise|itp_type_horse, 0, 1224,abundance(50)|hit_points(165)|body_armor(30)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
 ["charger","Charger", [("charger_new",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(44)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_5]],
 ["warhorse_vaegir","Vaegir War Horse", [("charger_old",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(44)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_2]], ## CC
 ["warhorse_sarranid","Sarranian War Horse", [("warhorse_sarranid",0)], itp_merchandise|itp_type_horse, 0, 1811,abundance(40)|hit_points(165)|body_armor(44)|difficulty(4)|horse_speed(40)|horse_maneuver(44)|horse_charge(32)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_6]],
 ["warhorse_steppe","Steppe Charger", [("warhorse_steppe",0)], itp_merchandise|itp_type_horse, 0, 1400,abundance(45)|hit_points(150)|body_armor(30)|difficulty(4)|horse_speed(40)|horse_maneuver(50)|horse_charge(28)|horse_scale(112),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_3,fac_kingdom_2]],
  ## CC

#whalebone crossbow, yew bow, war bow, arming sword 
 ["arrows","Arrows", [("arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("arena_quiver", ixmesh_carry|imodbit_large_bag),("quiver", ixmesh_inventory),("arena_quiver", ixmesh_inventory|imodbit_large_bag)], itp_type_arrows|itp_merchandise|itp_default_ammo, itcf_carry_quiver_back, 72,weight(3)|abundance(160)|weapon_length(95)|thrust_damage(1,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger],
 ["khergit_arrows","Khergit Arrows", [("arrow_b",0),("flying_arrow_b",ixmesh_flying_ammo),("quiver_b", ixmesh_carry),("quiver_b", ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 410,weight(3.5)|abundance(30)|weapon_length(95)|thrust_damage(3,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger, [fac_kingdom_3]],
 ["barbed_arrows","Barbed Arrows", [("barbed_arrow",0),("flying_barbed_arrow",ixmesh_flying_ammo),("quiver_d", ixmesh_carry),("quiver_d", ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 124,weight(3)|abundance(70)|weapon_length(95)|thrust_damage(2,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger],
 ["bodkin_arrows","Bodkin Arrows", [("piercing_arrow",0),("flying_piercing_arrow",ixmesh_flying_ammo),("quiver_c", ixmesh_carry),("quiver_c", ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 350,weight(3)|abundance(50)|weapon_length(91)|thrust_damage(3,pierce)|max_ammo(28),imodbits_missile,missile_distance_trigger],
 
 ## CC
 ["flat_headed_arrows","Flat Headed Arrows", [("flat_headed_arrow",0),("flying_flat_headed_arrow",ixmesh_flying_ammo),("flat_headed_arrow_quiver", ixmesh_carry),("flat_headed_arrow_quiver", ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back_right, 700,weight(6)|abundance(25)|weapon_length(90)|thrust_damage(6,pierce)|max_ammo(23),imodbits_missile,missile_distance_trigger, [fac_kingdom_3]],
 ["bamboo_arrows","Bamboo Arrows", [("bamboo_arrow",0),("flying_bamboo_arrow",ixmesh_flying_ammo),("bamboo_arrow_quiver", ixmesh_carry),("bamboo_arrow_quiver", ixmesh_inventory)], itp_type_arrows|itp_merchandise, itcf_carry_quiver_back, 150,weight(2.5)|abundance(70)|weapon_length(95)|thrust_damage(2,pierce)|max_ammo(30),imodbits_missile,missile_distance_trigger, [fac_kingdom_6]],
 ["piercing_arrows_2","Piercing Arrows", [("piercing_arrow_2",0),("flying_piercing_arrow_2",ixmesh_flying_ammo),("piercing_arrow_2_quiver", ixmesh_carry),("piercing_arrow_2_quiver", ixmesh_inventory)], itp_type_arrows|itp_can_penetrate_shield|itp_extra_penetration, itcf_carry_quiver_back_right, 900,weight(4)|abundance(10)|weapon_length(91)|thrust_damage(5,pierce)|max_ammo(28),imodbits_missile,missile_distance_trigger],
 ## CC
 ...
 ["cartridges","Cartridges", [("cartridge_a",0)], itp_type_bullets|itp_merchandise|itp_can_penetrate_shield|itp_default_ammo, 0, 41,weight(2.25)|abundance(90)|weapon_length(3)|thrust_damage(1,pierce)|max_ammo(50),imodbits_missile,missile_distance_trigger],
...
["scale_armor", "Scale Armor", [("lamellar_armor_e",0)], itp_type_body_armor  |itp_covers_legs ,0,
 2558 , weight(25)|abundance(100)|head_armor(0)|body_armor(52)|leg_armor(13)|difficulty(8) ,imodbits_armor ], ## CC
...
##armors_e
## CC
["khergit_elite_armor", "Khergit Elite Armor", [("lamellar_armor_c",0)], itp_type_body_armor  |itp_covers_legs ,0,
 3828 , weight(25)|abundance(100)|head_armor(0)|body_armor(52)|leg_armor(16)|difficulty(8) ,imodbits_armor ],
["vaegir_elite_armor", "Vaegir Elite Armor", [("lamellar_armor_d",0)], itp_type_body_armor  |itp_covers_legs ,0,
 3828 , weight(25)|abundance(100)|head_armor(0)|body_armor(52)|leg_armor(16)|difficulty(8) ,imodbits_armor ],
...
["double_sided_lance", "Double Sided Lance", [("lance_dblhead",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_staff, 261 , weight(4.0)|difficulty(0)|spd_rtng(95) | weapon_length(128)|swing_damage(25, cut) | thrust_damage(27 ,  pierce),imodbits_polearm ], ## CC
...
## CC
["light_lance",         "Light Lance", [("spear_b_2-75m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear,
...
["lance",         "Lance", [("spear_d_2-8m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear,
...
["heavy_lance",         "Heavy Lance", [("spear_f_2-9m",0)], itp_couchable|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear,
...
["steel_shield", "Steel Shield", [("shield_dragon",0)], itp_type_shield, itcf_carry_round_shield,  697 , weight(4)|hit_points(700)|body_armor(27)|spd_rtng(61)|shield_width(40),imodbits_shield ],
...
370 , weight(5)|hit_points(550)|body_armor(14)|spd_rtng(78)|shield_width(43)|shield_height(100),imodbits_shield,
 [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_shield_item_set_banner", "tableau_pavise_shield_1", ":agent_no", ":troop_no")])]],
## CC
["tab_shield_pavise_e", "Tower Shield",   [("tableau_shield_pavise_3_new" ,0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield,  
...
155 , weight(4)|difficulty(1)|spd_rtng(95) | shoot_speed(28) | thrust_damage(22 ,  pierce)|max_ammo(7)|weapon_length(32),imodbits_thrown, missile_distance_trigger, [fac_kingdom_1]],
...
285 , weight(5)|difficulty(1)|spd_rtng(93) | shoot_speed(27) | thrust_damage(25 ,  pierce)|max_ammo(7)|weapon_length(45),imodbits_thrown,missile_distance_trigger, [fac_kingdom_1]],
## CC
["javelin",         "Javelins", [("javelin",0),("javelins_quiver_new", ixmesh_carry),("javelins_quiver_new", ixmesh_inventory)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn, 
300, weight(4)|difficulty(1)|spd_rtng(91) | shoot_speed(25) | thrust_damage(34 ,  pierce)|max_ammo(5)|weapon_length(75),imodbits_thrown,missile_distance_trigger, [fac_kingdom_4, fac_kingdom_6]],
...
525 , weight(3)|difficulty(2)|spd_rtng(87) | shoot_speed(22) | thrust_damage(44 ,  pierce)|max_ammo(4)|weapon_length(65),imodbits_thrown,missile_distance_trigger, [fac_kingdom_4, fac_kingdom_6]],
...
560 , weight(2.75)|difficulty(2)|spd_rtng(89) | shoot_speed(24) | thrust_damage(45 ,  pierce)|max_ammo(4)|weapon_length(65),imodbits_thrown,missile_distance_trigger, [fac_kingdom_4, fac_kingdom_6]],
...
["stones",         "Stones", [("throwing_stone",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_stone, 1 , weight(4)|difficulty(0)|spd_rtng(97) | shoot_speed(30) | thrust_damage(11 ,  blunt)|max_ammo(18)|weapon_length(8),imodbit_large_bag,missile_distance_trigger],
["throwing_knives", "Throwing Knives", [("throwing_knife",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_knife, 76 , weight(2.5)|difficulty(0)|spd_rtng(121) | shoot_speed(25) | thrust_damage(19 ,  cut)|max_ammo(14)|weapon_length(0),imodbits_thrown, missile_distance_trigger],
["throwing_knives_melee", "Throwing Knives", [("throwing_knife_melee",0)], itp_type_one_handed_wpn|itp_primary|itp_no_parry , itc_dagger|itcf_carry_dagger_front_left, 76 , weight(0.5)|difficulty(0)|spd_rtng(121)| weapon_length(35)|swing_damage(17, cut) | thrust_damage(14,  pierce), imodbits_sword], ## CC
["throwing_daggers", "Throwing Daggers", [("throwing_dagger",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_knife, 193 , weight(2.5)|difficulty(0)|spd_rtng(110) | shoot_speed(24) | thrust_damage(25 ,  cut)|max_ammo(13)|weapon_length(0),imodbits_thrown,missile_distance_trigger],
["throwing_daggers_melee", "Throwing Daggers", [("throwing_dagger_melee",0)], itp_type_one_handed_wpn|itp_primary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_left, 193 , weight(0.5)|difficulty(0)|spd_rtng(110) |weapon_length(40)|swing_damage(22, cut) | thrust_damage(19,  pierce), imodbits_sword], ## CC


#TODO: Light Trowing axe, Heavy Throwing Axe

## CC
["light_throwing_axes", "Light Throwing Axes", [("francisca",0),("francisca_quiver", ixmesh_carry),("francisca_inventory", ixmesh_inventory)], itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe|itcf_carry_quiver_front_right|itcf_show_holster_when_drawn,
360, weight(5)|difficulty(2)|spd_rtng(99) | shoot_speed(18) | thrust_damage(35,cut)|max_ammo(4)|weapon_length(53),imodbits_thrown_minus_heavy,missile_distance_trigger, [fac_kingdom_4]],
...
["throwing_axes", "Throwing Axes", [("throwing_axe_a",0),("throwing_axe_a_quiver", ixmesh_carry),("throwing_axe_a_inventory", ixmesh_inventory)], itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe|itcf_carry_quiver_front_right|itcf_show_holster_when_drawn,
490, weight(5)|difficulty(3)|spd_rtng(98) | shoot_speed(18) | thrust_damage(39,cut)|max_ammo(4)|weapon_length(53),imodbits_thrown_minus_heavy,missile_distance_trigger, [fac_kingdom_4]],
...
["heavy_throwing_axes", "Heavy Throwing Axes", [("throwing_axe_b",0),("throwing_axe_b_quiver", ixmesh_carry),("throwing_axe_b_inventory", ixmesh_inventory)], itp_type_thrown |itp_merchandise|itp_primary|itp_next_item_as_melee,itcf_throw_axe|itcf_carry_quiver_front_right|itcf_show_holster_when_drawn,
620, weight(5)|difficulty(4)|spd_rtng(97) | shoot_speed(18) | thrust_damage(44,cut)|max_ammo(4)|weapon_length(53),imodbits_thrown_minus_heavy,missile_distance_trigger, [fac_kingdom_4]],
...
58 , weight(1)|difficulty(1)|spd_rtng(97) | shoot_speed(55) | thrust_damage(18 ,  pierce  )|accuracy(99),imodbits_bow ],
...
164 , weight(1.25)|difficulty(2)|spd_rtng(94) | shoot_speed(56) | thrust_damage(20 ,  pierce)|accuracy(97),imodbits_bow ],
...
145 , weight(1.75)|difficulty(3)|spd_rtng(79) | shoot_speed(56) | thrust_damage(22 ,  pierce)|accuracy(95),imodbits_bow, [], [fac_kingdom_4]],
...
269 , weight(1.25)|difficulty(3)|spd_rtng(90) | shoot_speed(57) | thrust_damage(21 ,pierce)|accuracy(96),imodbits_bow, [], [fac_kingdom_3]],
...
375 , weight(1.25)|difficulty(4)|spd_rtng(89) | shoot_speed(57) | thrust_damage(22 ,pierce)|accuracy(95),imodbits_bow, [], [fac_kingdom_6]],
...
437 , weight(1.25)|difficulty(4)|spd_rtng(88) | shoot_speed(58) | thrust_damage(23 ,pierce)|accuracy(94),imodbit_cracked | imodbit_bent | imodbit_masterwork ],
...
728 , weight(1.5)|difficulty(5)|spd_rtng(84) | shoot_speed(59) | thrust_damage(25 ,pierce)|accuracy(92),imodbits_bow, [], [fac_kingdom_2]],
["steel_long_bow",    "Steel Bow", [("steel_long_bow",0),("steel_long_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed|itp_bonus_against_shield, itcf_shoot_bow|itcf_carry_bow_back, 
1250 , weight(3)|difficulty(7)|spd_rtng(82) | shoot_speed(70) | thrust_damage(30 ,  pierce)|accuracy(93),imodbits_bow ],
## CC
...
["flintlock_pistol", "Flintlock Pistol", [("flintlock_pistol",0)], itp_type_pistol |itp_merchandise|itp_primary ,itcf_shoot_pistol|itcf_reload_pistol|itcf_carry_pistol_front_left, 230 , weight(1.5)|difficulty(0)|spd_rtng(38) | shoot_speed(160) | thrust_damage(45 ,pierce)|max_ammo(1)|accuracy(65),imodbits_none,
...
["practice_arrows_2","Practice Arrows", [("arena_arrow",0),("flying_arrow",ixmesh_flying_ammo),("quiver", ixmesh_carry),("quiver", ixmesh_inventory)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(1.5)|weapon_length(95)|max_ammo(80),imodbits_missile,missile_distance_trigger],
