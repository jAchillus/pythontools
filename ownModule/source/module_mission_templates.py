...
pilgrim_disguise = [itm_pilgrim_hood,itm_pilgrim_disguise,itm_practice_staff, itm_throwing_daggers, itm_throwing_daggers_melee] ## CC
  ...
  # 0, 0, ti_once, [],
   # [
    # (try_for_agents, ":agent_no"),
      ...
      # (troop_set_slot, ":troop_no", slot_troop_xp_old, ":troop_xp"),
    # (try_end),
   # ])
  ...
  1, 0, 0, [],
    [
      ...
      ## rhodok_sergeant
        ...
        (try_begin),
          (agent_get_wielded_item, ":weapon_item", ":agent_no", 0),
          (is_between, ":weapon_item", "itm_long_axe", "itm_bardiche"),
          (agent_get_horse, ":horse_agent", ":agent_no"),
          (item_get_type, ":item_type", ":weapon_item"),
          (try_begin),
            (ge, ":horse_agent", 0),
            (eq, ":item_type", itp_type_polearm),
            (store_add, ":dest_weapon", ":weapon_item", 1),
            (agent_unequip_item, ":agent_no", ":weapon_item"),
            (agent_equip_item, ":agent_no", ":dest_weapon"),
          (else_try),
            (lt, ":horse_agent", 0),
            (eq, ":item_type", itp_type_two_handed_wpn),
            (store_sub, ":dest_weapon", ":weapon_item", 1),
            (agent_unequip_item, ":agent_no", ":weapon_item"),
            (agent_equip_item, ":agent_no", ":dest_weapon"),
          (try_end),
        (try_end),
      ...
      (try_begin),
        ...
        (try_begin), 
          ...
          (try_begin),
            ...
            (try_end),
          (try_end),
          # regain lost HP: 6% per skill level of skl_ironflesh
          (try_begin),
            (gt, ":dest_damage", 0),
            (agent_get_slot, ":backup_hp", ":inflicted_agent", slot_agent_backup_hp),
            (agent_get_slot, ":skl_level", ":inflicted_agent", slot_agent_ironflesh_level),
            (store_agent_hit_points, ":inflicted_agent_hp", ":inflicted_agent", 1),
            (store_add, ":agent_ideal_hp", ":inflicted_agent_hp", ":backup_hp"),
            (assign, ":regained_hp", ":dest_damage"),
            (val_min, ":regained_hp", ":agent_ideal_hp"),
            (val_mul, ":regained_hp", ":skl_level"),
            (val_mul, ":regained_hp", 6), 
            (val_div, ":regained_hp", 100),
            (val_add, ":backup_hp", ":regained_hp"),
            (agent_set_slot, ":inflicted_agent", slot_agent_backup_hp, ":backup_hp"),
            (try_begin),
              (eq, ":inflicted_agent", ":player_agent"),
              (gt, ":backup_hp", 0),
              (store_div, ":regained_speed", ":skl_level", 5),
              (val_add, ":regained_speed", 1),
              (store_div, ":needed_time", ":backup_hp", ":regained_speed"),
              (store_mod, ":needed_time_mod", ":backup_hp", ":regained_speed"),
              (try_begin),
                (gt, ":needed_time_mod", 0),
                (val_add, ":needed_time", 1),
              (try_end),
              (assign, reg4, ":needed_time"),
              (store_sub, reg5, ":needed_time", 1),
              (assign, reg6, ":backup_hp"),
              (try_begin),
                (eq, "$g_show_regain_hp_info", 1),
                (display_message, "@Because of ironflesh skill, you will regain {reg6} lost HP in {reg4} {reg5?seconds:second}."),
              (try_end),
            (try_end),
          (try_end),

          (try_begin),
            (lt, ":dest_damage", ":inflicted_damage"),
            (store_agent_hit_points, ":inflicted_agent_hp", ":inflicted_agent", 1),
            (store_sub, ":dest_hp", ":inflicted_agent_hp", ":dest_damage"),
            (try_begin),
              (gt, ":dest_hp", 0),
              (agent_set_no_death_knock_down_only, ":inflicted_agent", 1),
              (agent_set_slot, ":inflicted_agent", slot_agent_dest_hp, ":dest_hp"),
            (else_try),
              (agent_set_no_death_knock_down_only, ":inflicted_agent", 0),
              (agent_set_slot, ":inflicted_agent", slot_agent_dest_hp, 0),
            (try_end),
          (try_end),
        # (else_try),
...
custom_commander_agent_init_skl_ironflesh = (
  ti_on_agent_spawn, 0, 0, [],
  [
    (store_trigger_param_1, ":agent_no"),
    (agent_get_troop_id, ":troop_no", ":agent_no"),
    (store_skill_level, ":skl_level", skl_ironflesh, ":troop_no"),
    (agent_set_slot, ":agent_no", slot_agent_ironflesh_level, ":skl_level"),
  ])
    
custom_commander_agent_regain_lost_hp = (
  1, 0, 0, [], 
  [
    (get_player_agent_no, ":player_agent"),
    (try_for_agents, ":agent_no"),
      ...
      (agent_get_slot, ":backup_hp", ":agent_no", slot_agent_backup_hp),
      (try_begin),
        (this_or_next|agent_is_alive, ":agent_no"),
        (eq, ":agent_no", ":player_agent"),
        (gt, ":backup_hp", 0),
        (call_script, "script_get_troop_max_hp", ":troop_no"),
        (assign, ":max_hp", reg0),
        (store_agent_hit_points, ":agent_hp", ":agent_no", 1),
        (store_sub, ":lost_hp", ":max_hp", ":agent_hp"),
        (gt, ":lost_hp", 0), # not full HP 
        (store_skill_level, ":skl_level", skl_ironflesh, ":troop_no"),
        (store_div, ":regained_hp", ":skl_level", 5),
        (val_add, ":regained_hp", 1),
        (val_min, ":regained_hp", ":backup_hp"),
        (val_min, ":regained_hp", ":lost_hp"),
        (val_add, ":agent_hp", ":regained_hp"),
        (agent_set_hit_points, ":agent_no", ":agent_hp", 1),
        (val_sub, ":backup_hp", ":regained_hp"),
        (agent_set_slot, ":agent_no", slot_agent_backup_hp, ":backup_hp"),
        (try_begin),
          (eq, ":backup_hp", 0),
          (eq, ":agent_no", ":player_agent"),
          (display_message, "@Your injuries have been stabilized."),
        (try_end),
      (try_end),
    (try_end),
  ])
...
#custom_commander_agent_convert_class = (
#  1, 0, 0, [], 
#  [
#    (get_player_agent_no, ":player_agent"),
#    (try_for_agents, ":agent_no"),
...
#        (eq, ":troop_no", "trp_khergit_veteran_horse_archer"),
#        (agent_get_ammo, ":agent_ammo", ":agent_no"),
#        (try_begin),
#          (gt, ":agent_ammo", 0),
#          (agent_set_division, ":agent_no", grc_archers),
#        (else_try),
#          (gt, "$g_archer_2nd_class", -1),
#          (agent_set_division, ":agent_no", "$g_archer_2nd_class"),
#        (try_end),
#      (else_try),
#        (try_begin),
...
#          (le, ":agent_horse_id", -1),
#          (gt, "$g_cavalry_2nd_class", -1),
#          (agent_set_division, ":agent_no", "$g_cavalry_2nd_class"),
#        (try_end),
#        (try_begin),
...
# custom_commander_agent_pickup_weapons = (
  # 3, 0, 0, [],
    # [
    # (get_player_agent_no, ":player_agent"),
    # (try_for_agents, ":agent_no"),
      ...
      # (try_begin),
        # (troop_is_hero, ":troop_no"),
        # (assign, ":continue", "$g_heroes_pickup_weapons"),
      # (else_try),
        # (assign, ":continue", "$g_regulars_pickup_weapons"),
      # (try_end),
      # (eq, ":continue", 1),
      # (agent_get_wielded_item, ":agent_right_wp", ":agent_no"),
      # (agent_get_team, ":agent_team", ":agent_no"),
      # (agent_get_division, ":agent_division", ":agent_no"),
      # (team_get_weapon_usage_order, ":weapon_usage_order", ":agent_team", ":agent_division"),
      # (try_begin),
        # (eq, ":weapon_usage_order", wordr_use_blunt_weapons),
        # (le, ":agent_right_wp", -1),
        # (assign, ":end_cond", 4),
        # (try_for_range, ":cur_slot", 0, ":end_cond"),
          # (agent_get_item_slot, ":cur_weapon", ":agent_no", ":cur_slot"),
          # (gt, ":cur_weapon", -1),
          # (item_get_type, ":item_type", ":cur_weapon"), # right handed weapon
      ...
      # (try_end),
      # (try_begin),
        # (neq, ":weapon_usage_order", wordr_use_blunt_weapons),
        # (gt, ":agent_right_wp", -1),
        # (store_item_value, ":value", ":agent_right_wp"),
        # (item_get_type, ":item_type", ":agent_right_wp"),
        # (agent_get_position, pos2, ":agent_no"),
        # (assign, ":weapon_exchanged", 0),
        # (try_for_agents, ":agent_no_2"),
          # (eq, ":weapon_exchanged", 0),
          # (neq, ":agent_no_2", ":agent_no"),
          # (agent_is_human, ":agent_no_2"),
          # (neg|agent_is_alive, ":agent_no_2"),
          # (agent_get_position, pos3, ":agent_no_2"),
          # (get_distance_between_positions, ":dist", pos2, pos3),
          # (le, ":dist", 150),
          # (agent_get_wielded_item, ":agent_2_right_wp", ":agent_no_2"),
          # right handed weapon
          # (gt, ":agent_2_right_wp", -1),
          # (store_item_value, ":value_2", ":agent_2_right_wp"),
          # (item_get_type, ":item_type_2", ":agent_2_right_wp"),
          # (eq, ":item_type_2", ":item_type"), # same type
          # (neq, ":item_type", itp_type_polearm),
          # (gt, ":value_2", ":value"),
          # exchange weapon
          # (agent_unequip_item, ":agent_no", ":agent_right_wp"),
          # (agent_equip_item, ":agent_no", ":agent_2_right_wp"),
          # (agent_set_wielded_item, ":agent_no", ":agent_2_right_wp"),
          # (agent_unequip_item, ":agent_no_2", ":agent_2_right_wp"),
          # (agent_equip_item, ":agent_no_2", ":agent_right_wp"),
          # (agent_set_wielded_item, ":agent_no_2", ":agent_right_wp"),
          # (assign, ":weapon_exchanged", 1),
        # (try_end),
      # (try_end),
    # (try_end),
   # ])
   
custom_commander_main_hero_fallen_info = (
  1, 0, 15, [(main_hero_fallen)],
    [
    (call_script, "script_tutorial_message_set_format", 17, 17, 400, 650, 0, 1),
    (tutorial_message, "@Continue watching, or press space key to quit.", 0, 5),
   ])
...
common_siege_defender_reinforcement_check = (
  ...
  [
    ...
    (try_begin),
      ...
      (this_or_next|lt, "$defender_reinforcement_stage", 11),
      ...
      (add_reinforcements_to_entry, 5, 4),
...
0, 0, ti_once, [(main_hero_fallen), (key_clicked, key_space)],
  [
...
##           ]),
  ...
  (1, 0, 0, [],
   [
     (eq, "$g_mt_mode", abm_training),
     (call_script, "script_tutorial_message_set_format", 20, 20, 380, 700, 0, 0),
     (get_player_agent_no, ":player_agent"),
     ...
     (str_store_string, s1, "@{s1}^^Opponents Remaining: {reg1}"),
     (tutorial_message, s1, 0),
     ]),
  ## CC
...
#-----------------------------------------------------------------
  ...
  (
    ...
    "You lead your men to battle.",
    [
     (1,mtef_defenders|mtef_team_0,0,aif_start_alarmed,15,[]), ## CC
     (0,mtef_defenders|mtef_team_0,0,aif_start_alarmed,0,[]),
     (4,mtef_attackers|mtef_team_1,0,aif_start_alarmed,15,[]), ## CC
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (0, 0, ti_once, [], [(assign,"$g_battle_won",0),
                           ...
                           (call_script, "script_combat_music_set_situation_with_culture"),
                           ## CC
                           (assign, "$g_defender_reinforcement_limit", 9),
                           (get_player_agent_no, ":player_agent"),
                           (agent_get_team, ":player_team", ":player_agent"),
                           (set_show_messages, 0),
      ...
      (lt,"$defender_reinforcement_stage","$g_defender_reinforcement_limit"),
                ...
                (ge,":mission_time",10),
                ## CC
                (store_sub, ":reinforcement_differ", "$defender_reinforcement_stage", "$attacker_reinforcement_stage"),
                (lt, ":reinforcement_differ", 3),
                (assign, ":defenders", 0),
                (assign, ":attackers", 0),
                (try_for_agents, ":agent_no"),
                  (agent_is_human, ":agent_no"),
           ...
           [(add_reinforcements_to_entry,0,10), ## CC
            (assign, "$defender_reinforcement_limit_increased", 0),
            (val_add,"$defender_reinforcement_stage",1),
           ]),
      
      (1, 0, 5, [
                (lt,"$attacker_reinforcement_stage", 9), 
                (store_mission_timer_a,":mission_time"),
                (ge,":mission_time",10),
                ## CC
                (store_sub, ":reinforcement_differ", "$attacker_reinforcement_stage", "$defender_reinforcement_stage"),
                (lt, ":reinforcement_differ", 3),
                (assign, ":defenders", 0),
                (assign, ":attackers", 0),
                (try_for_agents, ":agent_no"),
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (1, 0, 5, [(lt,"$defender_reinforcement_stage",6), ## CC
                 (store_mission_timer_a,":mission_time"),
                 (ge,":mission_time",10),
                 (store_normalized_team_count,":num_defenders", 0),
                 (lt,":num_defenders",6)],
           [(add_reinforcements_to_entry,0,6),(val_add,"$defender_reinforcement_stage",1)]),
      (1, 0, 5, [(lt,"$attacker_reinforcement_stage", 6), ## CC
                 (store_mission_timer_a,":mission_time"),
                 (ge,":mission_time",10),
                 (store_normalized_team_count,":num_attackers", 1),
                 (lt,":num_attackers",6)],
...
## CC
  ...
  (
    ...
    [
     ...
     (61,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,0,[]), ## CC
    ...
    [
      ...
      common_siege_assign_men_to_belfry,
      custom_commander_check_player_can_join_battle_dismounted, ## CC
      custom_commander_main_hero_fallen_info, ## CC
    ] + custom_commander_commom_triggers, ## CC
  ),
        ...
        [
          (try_begin), 
            ...
            (try_for_agents, ":agent_no"), # enemy
              ...
              (ge,"$attacker_reinforcement_stage",4),
