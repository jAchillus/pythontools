...
skills = [
  ("trade","Trade",sf_base_att_cha|sf_effects_party,10,"Every level of this skill reduces your trade penalty by 5%%. (Party skill)  Max level: 10"),
  ...
  ("surgery","Surgery",sf_base_att_int|sf_effects_party,10,"Each point to this skill gives a 5.5%% chance that a mortally struck party member will be wounded rather than killed. (Party skill)  Max level: 10"), 
  ...
  ("athletics","Athletics",sf_base_att_agi,10,"Improves your running speed. (Personal skill)  Max level: 10"),
  ("shield","Shield",sf_base_att_agi,10,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)  Max level: 10"),
  ("weapon_master","Weapon Master",sf_base_att_agi,10,"Makes it easier to learn weapon proficiencies and increases the proficiency limits. Limits go as: 60, 100, 140, 180, 220, 260, 300, 340, 380, 420, 460. (Personal skill)  Max level: 10"),
  ...
  ("ironflesh","Ironflesh",sf_base_att_str,15,"Each point to this skill increases hit points by +2, and regain 6%% per skill level of hit-points lost in current battle. (Personal skill)  Max level: 15"), 
