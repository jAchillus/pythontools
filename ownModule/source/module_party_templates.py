...
## CC
  # for castles and towns
  ("kingdom_1_reinforcements_a", "{!}kingdom_1_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_swadian_footman,3,5),(trp_swadian_skirmisher,4,8)]),
  ("kingdom_1_reinforcements_b", "{!}kingdom_1_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_swadian_footman,2,4),(trp_swadian_infantry,1,2),(trp_swadian_crossbowman,1,2)]),
  ("kingdom_1_reinforcements_c", "{!}kingdom_1_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_swadian_noble_lad,1,2),(trp_swadian_infantry,3,5)]),

  ("kingdom_2_reinforcements_a", "{!}kingdom_2_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_vaegir_veteran,3,5),(trp_vaegir_skirmisher,4,8)]),
  ("kingdom_2_reinforcements_b", "{!}kingdom_2_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_vaegir_veteran,2,4),(trp_vaegir_infantry,1,2),(trp_vaegir_archer,1,2)]),
  ("kingdom_2_reinforcements_c", "{!}kingdom_2_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_vaegir_noble_lad,1,2),(trp_vaegir_infantry,3,5)]),

  ("kingdom_3_reinforcements_a", "{!}kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_khergit_tribesman,4,8),(trp_khergit_skirmisher,4,8)]),
  ("kingdom_3_reinforcements_b", "{!}kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_khergit_horseman,2,4),(trp_khergit_horse_archer,1,2),(trp_khergit_skirmisher,3,5)]),
  ("kingdom_3_reinforcements_c", "{!}kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_khergit_veteran_horse_archer,1,2),(trp_khergit_horse_archer,2,3),(trp_khergit_horseman,2,3)]),

  ("kingdom_4_reinforcements_a", "{!}kingdom_4_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_nord_trained_footman,4,8),(trp_nord_archer,3,5)]),
  ("kingdom_4_reinforcements_b", "{!}kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_nord_veteran_archer,1,2),(trp_nord_warrior,1,2),(trp_nord_trained_footman,2,4)]),
  ("kingdom_4_reinforcements_c", "{!}kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_nord_veteran,1,2),(trp_nord_warrior,2,4)]),

  ("kingdom_5_reinforcements_a", "{!}kingdom_5_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_rhodok_trained_spearman,4,8),(trp_rhodok_trained_crossbowman,3,5)]),
  ("kingdom_5_reinforcements_b", "{!}kingdom_5_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_rhodok_veteran_spearman,1,2),(trp_rhodok_trained_spearman,1,2),(trp_rhodok_trained_crossbowman,2,4)]),
  ("kingdom_5_reinforcements_c", "{!}kingdom_5_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_rhodok_veteran_spearman,2,4),(trp_rhodok_veteran_crossbowman,1,2)]),

  ("kingdom_6_reinforcements_a", "{!}kingdom_6_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_sarranid_veteran_footman,3,6),(trp_sarranid_skirmisher,4,7)]),
  ("kingdom_6_reinforcements_b", "{!}kingdom_6_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_sarranid_veteran_footman,2,4),(trp_sarranid_infantry,1,2),(trp_sarranid_archer,1,2)]),
  ("kingdom_6_reinforcements_c", "{!}kingdom_6_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_sarranid_noble_lad,1,2),(trp_sarranid_infantry,3,5)]),

  # for lords
  ("kingdom_1_lord_reinf_a", "{!}kingdom_1_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_swadian_footman,4,8),(trp_swadian_skirmisher,3,5)]),
  ("kingdom_1_lord_reinf_b", "{!}kingdom_1_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_swadian_infantry,2,4),(trp_swadian_noble_lad,1,2),(trp_swadian_crossbowman,1,2)]),
  ("kingdom_1_lord_reinf_c", "{!}kingdom_1_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_swadian_knight,1,1),(trp_swadian_man_at_arms,1,2),(trp_swadian_noble_lad,2,3)]),

  ("kingdom_2_lord_reinf_a", "{!}kingdom_2_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_vaegir_veteran,4,8),(trp_vaegir_skirmisher,3,5)]),
  ("kingdom_2_lord_reinf_b", "{!}kingdom_2_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_vaegir_infantry,2,4),(trp_vaegir_noble_lad,1,2),(trp_vaegir_archer,1,2)]),
  ("kingdom_2_lord_reinf_c", "{!}kingdom_2_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_vaegir_knight,1,1),(trp_vaegir_horseman,1,2),(trp_vaegir_noble_lad,2,3)]),
  
  ("kingdom_3_lord_reinf_a", "{!}kingdom_3_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_khergit_tribesman,3,7),(trp_khergit_skirmisher,5,9)]),
  ("kingdom_3_lord_reinf_b", "{!}kingdom_3_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_khergit_horseman,3,5),(trp_khergit_horse_archer,1,2),(trp_khergit_skirmisher,2,4)]),
  ("kingdom_3_lord_reinf_c", "{!}kingdom_3_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_khergit_khan_guard,1,1),(trp_khergit_lancer,1,2),(trp_khergit_horseman,1,2),(trp_khergit_horse_archer,2,3)]),
  
  ("kingdom_4_lord_reinf_a", "{!}kingdom_4_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_nord_trained_footman,5,9),(trp_nord_archer,2,4)]),
  ("kingdom_4_lord_reinf_b", "{!}kingdom_4_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_nord_veteran_archer,1,2),(trp_nord_warrior,2,4),(trp_nord_trained_footman,1,2)]),
  ("kingdom_4_lord_reinf_c", "{!}kingdom_4_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_nord_champion,1,1),(trp_nord_veteran,1,2),(trp_nord_warrior,1,2),(trp_mercenary_horseman,2,2)]),

  ("kingdom_5_lord_reinf_a", "{!}kingdom_5_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_rhodok_trained_spearman,5,9),(trp_rhodok_trained_crossbowman,2,4)]),
  ("kingdom_5_lord_reinf_b", "{!}kingdom_5_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_rhodok_veteran_spearman,1,2),(trp_rhodok_trained_spearman,2,4),(trp_rhodok_trained_crossbowman,1,2)]),
  ("kingdom_5_lord_reinf_c", "{!}kingdom_5_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_rhodok_sergeant,1,1),(trp_rhodok_veteran_spearman,1,2),(trp_rhodok_veteran_crossbowman,1,2),(trp_mercenary_horseman,2,2)]),

  ("kingdom_6_lord_reinf_a", "{!}kingdom_6_lord_reinf_a", 0, 0, fac_commoners, 0, [(trp_sarranid_veteran_footman,4,7),(trp_sarranid_skirmisher,3,6)]),
  ("kingdom_6_lord_reinf_b", "{!}kingdom_6_lord_reinf_b", 0, 0, fac_commoners, 0, [(trp_sarranid_infantry,2,4),(trp_sarranid_noble_lad,1,2),(trp_sarranid_archer,1,2)]),
  ("kingdom_6_lord_reinf_c", "{!}kingdom_6_lord_reinf_c", 0, 0, fac_commoners, 0, [(trp_sarranid_mamluke,1,1),(trp_sarranid_horseman,1,2),(trp_sarranid_noble_lad,2,3)]),
## CC
