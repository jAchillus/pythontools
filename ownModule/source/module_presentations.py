  ...
  ("game_start",prsntf_read_only,0,[
    (ti_on_presentation_load,
      [
        ...
        (create_text_overlay, "$g_presentation_credits_obj_1", "@Custom Commander:^Restoration and Rebellion v{s1} ", tf_center_justify|tf_double_space|tf_vertical_align_center),
        (create_text_overlay, "$g_presentation_credits_obj_2", "@Custom Commander:^Restoration and Rebellion v{s1} ", tf_center_justify|tf_double_space|tf_vertical_align_center),
        (create_text_overlay, "$g_presentation_credits_obj_3", "@Custom Commander:^Restoration and Rebellion v{s1} ", tf_center_justify|tf_double_space|tf_vertical_align_center),
  ...
  # ("upgrade_trees", 0, 0, [
    # (ti_on_presentation_load,
      # [
        ...
        # (overlay_set_position, "$g_presentation_obj_1", pos1),
        # # factions
        # (try_for_range_backwards, ":i_upgrade_tree", 0, 9),
        ...
        # (try_begin),
          ...
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0,  "trp_swadian_recruit", 100, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1,  "trp_swadian_militia", 250, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2,  "trp_swadian_footman", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3,  "trp_swadian_infantry", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4,  "trp_swadian_sergeant", 700, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5,  "trp_swadian_skirmisher", 400, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6,  "trp_swadian_crossbowman", 550, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7,  "trp_swadian_sharpshooter", 700, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8,  "trp_swadian_noble_lad", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 9,  "trp_swadian_man_at_arms", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 10, "trp_swadian_knight", 700, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 11, "trp_swadian_guard_knight", 850, 400),
          # #(assign, "$temp_3", 12),
          ...
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 5),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 2, 3),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 3, 4),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 5, 6),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 6, 7),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 8, 9),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 9, 10),
        # (else_try),
          # (eq, ":faction_no", "fac_kingdom_2"), 
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0,  "trp_vaegir_recruit", 100, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1,  "trp_vaegir_footman", 250, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2,  "trp_vaegir_veteran", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3,  "trp_vaegir_infantry", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4,  "trp_vaegir_guard", 700, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5,  "trp_vaegir_skirmisher", 400, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6,  "trp_vaegir_archer", 550, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7,  "trp_vaegir_marksman", 700, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8,  "trp_vaegir_noble_lad", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 9,  "trp_vaegir_horseman", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 10, "trp_vaegir_knight", 700, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 11, "trp_vaegir_eagleeye_archer", 850, 0),
          # #(assign, "$temp_3", 12),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
        ...
        # (else_try),
          ...
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0, "trp_khergit_tribesman", 100, 300),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1, "trp_khergit_skirmisher", 250, 300),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2, "trp_khergit_horseman", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3, "trp_khergit_lancer", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4, "trp_khergit_horse_archer", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_khergit_veteran_horse_archer", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_khergit_khan_guard", 700, 400),
          # #(assign, "$temp_3", 7),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 4),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 2, 3),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 4, 5),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 3, 6),
        # (else_try),
          # (eq, ":faction_no", "fac_kingdom_4"),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0, "trp_nord_recruit", 100, 300),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1, "trp_nord_footman", 250, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2, "trp_nord_trained_footman", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3, "trp_nord_warrior", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4, "trp_nord_veteran", 700, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_nord_champion", 850, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_nord_huntsman", 250, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7, "trp_nord_archer", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8, "trp_nord_veteran_archer", 550, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 9, "trp_nord_champion_archer", 700, 200),
          # #(assign, "$temp_3", 10),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 6),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 2, 3),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 3, 4),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 4, 5),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 6, 7),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 7, 8),
        # (else_try),
          # (eq, ":faction_no", "fac_kingdom_5"),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0, "trp_rhodok_tribesman", 100, 300),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1, "trp_rhodok_spearman", 250, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2, "trp_rhodok_trained_spearman", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3, "trp_rhodok_veteran_spearman", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4, "trp_rhodok_sergeant", 700, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_rhodok_crossbowman", 250, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_rhodok_trained_crossbowman", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7, "trp_rhodok_veteran_crossbowman", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8, "trp_rhodok_sharpshooter", 700, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 9, "trp_rhodok_master_sergeant", 850, 400),
          # #(assign, "$temp_3", 10),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 5),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 2, 3),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 3, 4),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 5, 6),
        ...
        # (else_try),
          ...
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0,  "trp_sarranid_recruit", 100, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1,  "trp_sarranid_footman", 250, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2,  "trp_sarranid_veteran_footman", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3,  "trp_sarranid_infantry", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4,  "trp_sarranid_guard", 700, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5,  "trp_sarranid_skirmisher", 400, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6,  "trp_sarranid_archer", 550, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7,  "trp_sarranid_master_archer", 700, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8,  "trp_sarranid_noble_lad", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 9,  "trp_sarranid_horseman", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 10, "trp_sarranid_mamluke", 700, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 11,  "trp_sarranid_palace_guard", 850, 200),
          # #(assign, "$temp_3", 12),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
        ...
        # (else_try), # mercenaries
          # (eq, ":faction_no", "fac_kingdoms_end"),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0, "trp_watchman", 250, 100),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1, "trp_mercenary_swordsman", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2, "trp_hired_blade", 550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3, "trp_mercenary_crossbowman", 400, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4, "trp_caravan_guard", 250, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_mercenary_horseman", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_mercenary_cavalry", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7, "trp_mercenary_sharpshooter", 550, 0),
          # #(assign, "$temp_3", 8),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 3),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 4, 5),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 5, 6),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 3, 7),
        # (else_try), # outlaws
          # (eq, ":faction_no", "fac_robber_knights"),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0,  "trp_looter", 100, 600),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1,  "trp_bandit", 250, 600),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2,  "trp_brigand", 400, 600),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3,  "trp_mountain_bandit", 100, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4,  "trp_trained_mountain_bandit", 250, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 5,  "trp_veteran_mountain_bandit", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 6,  "trp_forest_bandit", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 7,  "trp_trained_forest_bandit", 700, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 8,  "trp_veteran_forest_bandit", 850, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 9,  "trp_sea_raider", 100, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 10,  "trp_trained_sea_raider", 250, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 11,  "trp_veteran_sea_raider", 400, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 12,  "trp_steppe_bandit",550, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 13, "trp_trained_steppe_bandit", 700, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 14, "trp_veteran_steppe_bandit", 850, 200),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 15, "trp_taiga_bandit", 100, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 16, "trp_trained_taiga_bandit", 250, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 17, "trp_veteran_taiga_bandit", 400, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 18, "trp_desert_bandit", 550, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 19, "trp_trained_desert_bandit", 700, 0),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 20, "trp_veteran_desert_bandit", 850, 0),
          # #(assign, "$temp_3", 15),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
          ...
          # (call_script, "script_prsnt_lines_to_link_two_troops", 7, 8),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 9, 10),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 10, 11),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 12, 13),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 13, 14),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 15, 16),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 16, 17),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 18, 19),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 19, 20),
        # (else_try), # rangers and manhunters
          # (eq, ":faction_no", "fac_khergits"),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 0, "trp_ranger_recruit", 100, 300),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 1, "trp_ranger_runner", 250, 300),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 2, "trp_ranger_woodsman", 400, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 3, "trp_ranger_warden", 550, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 4, "trp_ranger_huntmaster", 700, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_ranger_archer", 400, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_ranger_master_archer", 550, 400),
          # # manhunters
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 0,  "trp_manhunter", 100, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 1,  "trp_slave_driver", 250, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 2,  "trp_slave_hunter", 400, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 3,  "trp_slave_crusher", 550, 400),
          # (call_script, "script_prsnt_upgrade_tree_troop_info", 4,  "trp_slaver_chief", 700, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_ranger_acolyte", 100, 100),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 6, "trp_ranger_guide", 250, 100),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 7, "trp_ranger_woodswoman", 400, 100),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 8, "trp_ranger_shieldmaiden", 550, 100),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 9, "trp_ranger_huntress", 700, 100),
          # #(assign, "$temp_3", 5),
          # ## use slot-no above instead of troop-id
          # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
        ...
        # # (else_try), # Others
          # # (eq, ":faction_no", "fac_manhunters"),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 5, "trp_refugee", 100, 200),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 6,  "trp_peasant_woman", 100, 400),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 7,  "trp_follower_woman", 250, 300),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 8,  "trp_hunter_woman", 400, 300),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 9,  "trp_fighter_woman", 550, 300),
          # # (call_script, "script_prsnt_upgrade_tree_troop_info", 10,  "trp_sword_sister", 700, 300),
          # # (assign, "$temp_3", 5),
          # # use slot-no above instead of troop-id
          # # (call_script, "script_prsnt_lines_to_link_two_troops", 0, 1),
          # # (call_script, "script_prsnt_lines_to_link_two_troops", 1, 2),
  ...
  ("troop_note", 0, 0, [
    (ti_on_presentation_load,
      [
        ...
        (overlay_set_position, reg1, pos1),
        (val_sub, ":pos_y", 30),
        (try_for_range_backwards, ":skill_no", 23, 37), # 8 skills
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":trp_slot_prsnt_no", 0, "$temp_2"),
          ...
          (troop_get_slot, ":troop_no", "trp_temp_array_e", ":trp_slot_prsnt_no"),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            # (assign, "$temp_2", 8), # default faction: others
            # (store_troop_faction, ":troop_faction", "$temp"),
            # (try_begin),
              # (is_between, ":troop_faction", commom_kingdoms_begin, commom_kingdoms_end),
              # (store_sub, "$temp_2", ":troop_faction", commom_kingdoms_begin),
            # (else_try),
  ...
  ("mod_option", 0, mesh_note_window, [
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_prsnt_lines", 600, 2, 25, ":line_pos_y", 0),
        ...
        (try_begin),
          ...
          (val_add, ":pos_y", ":y_offset"),
          ## skill penalty
          (create_text_overlay, reg0, "@Cheat: Skill penalty by encumbrance:", tf_left_align),
          (position_set_y, pos1, ":pos_y"),
          (overlay_set_position, reg0, pos1),
          (create_check_box_overlay, "$g_presentation_obj_admin_panel_14", "mesh_checkbox_off", "mesh_checkbox_on"),
          (position_set_y, pos2, ":pos_y"),
        ...
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg0, pos1),
        (create_number_box_overlay, "$g_presentation_obj_admin_panel_23", 1, 4),
        (position_set_y, pos2, ":pos_y"),
        ...
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg0, pos1),
        (create_number_box_overlay, "$g_presentation_obj_admin_panel_24", 1, 4),
        (position_set_y, pos2, ":pos_y"),
        ...
        (overlay_add_item, "$g_presentation_obj_admin_panel_4", "@Old Style (60%)"),
        (overlay_add_item, "$g_presentation_obj_admin_panel_4", "@Old Style (80%)"),
        (overlay_add_item, "$g_presentation_obj_admin_panel_4", "@Old Style (100%)"),
  ...
  ("redefine_keys", 0, mesh_load_window, [
    ...
    (ti_on_presentation_run,
      ...
      (try_for_range, ":cur_slot", 0, len(keys)),
        ...
        (gt, "$temp", -1),
        (try_begin),
          (eq, "$temp", "$g_presentation_obj_admin_panel_1"),
          (assign, "$g_camera_up", ":key_no"),
        (else_try),
          (eq, "$temp", "$g_presentation_obj_admin_panel_2"),
          (assign, "$g_camera_down", ":key_no"),
        (else_try),
          (eq, "$temp", "$g_presentation_obj_admin_panel_3"),
          (assign, "$g_camera_zoom_in", ":key_no"),
        (else_try),
          (eq, "$temp", "$g_presentation_obj_admin_panel_4"),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_begin),
          (eq, ":object", "$g_presentation_obj_admin_panel_1"),
          (assign, "$temp", "$g_presentation_obj_admin_panel_1"),
          (overlay_set_alpha, "$g_presentation_obj_admin_panel_1", 0x80),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_2"),
          (assign, "$temp", "$g_presentation_obj_admin_panel_2"),
          (overlay_set_alpha, "$g_presentation_obj_admin_panel_2", 0x80),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_3"),
          (assign, "$temp", "$g_presentation_obj_admin_panel_3"),
          (overlay_set_alpha, "$g_presentation_obj_admin_panel_3", 0x80),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_4"),
          (assign, "$temp", "$g_presentation_obj_admin_panel_4"),
  ...
  ("shopping_list_of_food", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        ...
        (try_for_range, ":cur_button", 0, 7),
          ...
          (position_set_y, pos1, ":pos_y"),
          (overlay_set_position, reg1, pos1),
          (troop_set_slot, "trp_temp_array_e", ":cur_button", reg1),
          (val_sub, ":pos_y", 50),
        (try_end),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_for_range, ":cur_button", 0, 7),
          (troop_slot_eq, "trp_temp_array_e", ":cur_button", ":object"),
          (try_for_range, ":cur_food", food_begin, food_end),
  ...
  ("gambling", 0, 0, [
    (ti_on_presentation_load,
      [
        ...
        # character picture
        (create_mesh_overlay_with_tableau_material, reg0, -1, "tableau_troop_note_mesh", "trp_mystic_merchant"),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 500),
        (overlay_set_size, reg0, pos1),
        (position_set_x, pos1, 380),
  ...
  ("world_map", 0, mesh_load_window, [
    (ti_on_presentation_load,
      ...
      ## initialization part begin
        ...
        (store_mul, ":party_move_length", 0.4*1000, "$temp_2"), # $temp_2: map_precision
  ...
  ("sort_player_inventory", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        ...
        ## sort
        (create_game_button_overlay, "$g_presentation_obj_2", "@Auto-sort"),
        (position_set_x, pos1, 730),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$g_presentation_obj_2", pos1),
  ...
  ("equip_npcs", 0, 0, [
    (ti_on_presentation_load,
      [
        ...
        # Auto-upgrade equipms
        (create_in_game_button_overlay, "$g_presentation_obj_admin_panel_6", "@Upgrade equipms for all"),
        ...
        (position_set_y, pos1, 250),
        (overlay_set_position, "$g_presentation_obj_admin_panel_9", pos1),
        (troop_get_slot, ":upg_weapon", "$g_player_troop", slot_upgrade_weapon),
        (overlay_set_val, "$g_presentation_obj_admin_panel_9", ":upg_weapon"),
        
        (create_text_overlay, reg1, "@Upgrade weapons", tf_left_align),
        (position_set_x, pos1, 170),
        (position_set_y, pos1, 250),
        (overlay_set_position, reg1, pos1),
        ...
        (position_set_y, pos1, 200),
        (overlay_set_position, "$g_presentation_obj_admin_panel_7", pos1),
        (troop_get_slot, ":upg_armor", "$g_player_troop", slot_upgrade_armor),
        ...
        (position_set_y, pos1, 150),
        (overlay_set_position, "$g_presentation_obj_admin_panel_8", pos1),
        (troop_get_slot, ":upg_horse", "$g_player_troop", slot_upgrade_horse),
        ...
        (try_for_range, ":unused_height", 0, 8),
          (try_for_range, ":unused_width", 0, 6),
            ...
            (else_try),
              (gt, ":item_no", 0),
              (call_script, "script_troop_can_use_item", "$g_player_troop", ":item_no", ":item_imod"),
              (assign, ":can_use", reg0),
      ...
      (ti_on_presentation_run,
        ...
        (try_for_range, ":trp_slot_prsnt_no", 0, ":num_of_heroes"),
          (troop_slot_eq, "trp_temp_array_a", ":trp_slot_prsnt_no", "$g_player_troop"),
        ...
        (try_begin),
          ...
          (neq, ":new_troop", "$g_player_troop"),
          (assign, "$g_player_troop", ":new_troop"),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":slot_no", 0, 58),
        ...
        (try_begin),
          ...
          (troop_get_inventory_slot, ":cur_item", "$g_player_troop", ":item_slot_no"),
        (else_try),
          ...
          (try_begin),
            ...
            (try_for_range, ":new_slot", 0, ":end_cond"),
              (try_begin),
                ...
                (troop_get_inventory_slot, ":new_item", "$g_player_troop", ":new_slot"),
                (try_begin),
                  (gt, ":new_item", -1),
    ...
    (ti_on_presentation_mouse_enter_leave,
      ...
      (try_begin),
        ...
        (try_for_range, ":slot_no", 0, 58),
          ...
          (try_begin),
            (is_between, ":slot_no", 0, 9),
            (troop_get_inventory_slot, ":cur_item", "$g_player_troop", ":slot_no"),
            (troop_get_inventory_slot_modifier, ":cur_imod", "$g_player_troop", ":slot_no"),
          (else_try),
            (is_between, ":slot_no", 10, 58),
            (store_mul, ":item_slot_no", "$g_cur_page_of_loot_pool", 48),
            (val_add, ":item_slot_no", ":slot_no"),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_begin),
          (eq, ":object", "$g_presentation_obj_admin_panel_9"),
          (troop_set_slot, "$g_player_troop", slot_upgrade_weapon, ":value"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_7"),
          (troop_set_slot, "$g_player_troop", slot_upgrade_armor, ":value"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_8"),
          (troop_set_slot, "$g_player_troop", slot_upgrade_horse, ":value"),
        (else_try), # upgrade all
          ...
          (try_for_range, ":i_stack", 0, ":num_stacks"),
            (party_stack_get_troop_id, ":stack_troop", "p_main_party", ":i_stack"),
            (troop_is_hero, ":stack_troop"),
            (call_script, "script_loot_the_best_items_for_troop", ":stack_troop", "trp_temp_troop"),
          (try_end),
          (start_presentation, "prsnt_equip_npcs"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_5"),
  ...
  ("set_price_threshold",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (create_number_box_overlay, "$g_presentation_obj_1", 0, 1001),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$g_presentation_obj_1", pos1),
  ...
  ("upgrade_trees",0,0,[
    (ti_on_presentation_load,
      [
        ...
        # get_max_rows_and_cols
        (assign, reg3, 0), # max_cols
        (assign, "$g_cur_row", 1),
        (call_script, "script_troop_tree_get_max_rows_and_cols", ":troop_no", reg3),
        #(assign, ":max_cols", reg3),
        (assign, ":max_rows", "$g_cur_row"),
        ...
        (store_mul, "$g_cur_y", ":max_rows", 200),
        (val_max, "$g_cur_y", 600),
        (val_sub, "$g_cur_y", 200),
        (call_script, "script_troop_tree_iteration", ":troop_no", -100, "$g_cur_y"),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (store_add, ":total_slots", "$g_cur_slot_no", 1),
        (try_for_range, ":slot_no", 0, ":total_slots"),
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
          (troop_get_slot, "$temp", "trp_temp_array_b", ":slot_no"),
          (assign, "$g_presentation_next_presentation", "prsnt_upgrade_trees"),
          (start_presentation, "prsnt_troop_note"),
