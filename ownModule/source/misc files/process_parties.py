...
# def save_parties_new(parties):
  # file = open("./parties_new.py","w")
  # for i_party in xrange(len(parties)):
    # party = parties[i_party]
    # if (len(party) > 11):
      # file.write("(%.2f, %.2f),[], %d), \n"%((party[9][0]+2.5)/1.447, (party[9][1]-0.75)/1.369, party[11]))
    # else:
      # file.write("(%.2f, %.2f),[]), \n"%((party[9][0]+2.5)/1.447, (party[9][1]-0.75)/1.369))
  # file.close()
